          ...
          <div class="col-md-4">
            <form action="" method="post">
              ...
              <div class="form-group <?php echo form_error('jawab') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="jawab" value="<?= set_value('jawab'); ?>" />
              ...
              <div class="form-group <?php echo form_error('skor') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="number" name="skor" value="<?= set_value('skor'); ?>" />
                <?= form_error('skor', '<span class="help-block">', '</small>'); ?>
              </div>          
              <button type="submit" class="btn btn-primary">Simpan</button>
              <a href="<?= base_url('banksoal/skor'); ?> " class="btn btn-default">Cancel</a>
            </form>
          </div>
          <div class="col-md-8">
