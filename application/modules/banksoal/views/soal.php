...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php $kategori_idv = set_value('kategori_id'); ?>
    <!-- Default box -->
    <div class="box">
          ...
          <div class="col-md-12">
            ...
            <select name="kategori_id" id="kategori_id" class="form-control <?= form_error('kategori_id') ? 'is-invalid' : '' ?>">
              ...
              <?php foreach ($kategori as $k) : ?>
                <option value="<?= $k['id']; ?>" <?= $k['id'] == $kategori_idv ? ' selected="selected"' : ''; ?>><?= $k['kategori']; ?></option>
              <?php endforeach; ?>
            </select>
            <div class="invalid-feedback">
              ...
              <div class="form-group <?php echo form_error('soal') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="soal" value="<?= set_value('soal'); ?>" />
